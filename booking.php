      ...
      <div class="form-area">
        ...
        ?>
          ...
          <!-- <div class="form-group"> -->
              <h5> Seçilen araba:&nbsp;  <b><?php echo($car_name);?></b></h5>
         <!-- </div> -->
         
          <!-- <div class="form-group"> -->
            <h5> Plaka:&nbsp;<b> <?php echo($car_nameplate);?></b></h5>
          <!-- </div>      -->
        <!-- <div class="form-group"> -->
        <?php $today = date("Y-m-d") ?>
          <label><h5>Başlama tarihi:</h5></label>
            <input type="date" name="rent_start_date" min="<?php echo($today);?>" required="">
            &nbsp; 
          <label><h5>Bitme tarihi:</h5></label>
          <input type="date" name="rent_end_date" min="<?php echo($today);?>" required="">
        <!-- </div>      -->
        
        <h5> Araç tipini seçin:  &nbsp;
            <input onclick="reveal()" type="radio" name="radio" value="ac" ng-model="myVar"> <b>Klimalı </b>&nbsp;
            <input onclick="reveal()" type="radio" name="radio" value="non_ac" ng-model="myVar"><b>Klimasız </b>
        ...
        <div ng-switch-default>
                ...
                <!-- </div>    -->
                    ...
                    <!-- <div class="form-group"> -->
                <h5>Ücret: <b><?php echo("Rs. " . $ac_price . "/km and Rs. " . $ac_price_per_day . "/day");?></b><h5>    
                <!-- </div>    -->
                     </div>
                     <div ng-switch-when="non_ac">
                     <!-- <div class="form-group"> -->
                <h5>Ücret: <b><?php echo("Rs. " . $non_ac_price . "/km and Rs. " . $non_ac_price_per_day . "/day");?></b><h5>    
                <!-- </div>   -->
                     </div>
        </div>

         <h5> Şarj türü:  &nbsp;
            <input onclick="reveal()" type="radio" name="radio1" value="km"><b> KM başına</b> &nbsp;
            <input onclick="reveal()" type="radio" name="radio1" value="days"><b> Gün başına</b>
            ...
            <br><br>
                ...
                <select name="driver_id_from_dropdown" ng-model="myVar1">
                    ...
                    <?php }} 
                        ...
                        ?>
                    Afedersiniz! Şu anda kullanılabilir Sürücü yok, daha sonra tekrar deneyin...
                        <?php
                    }
                    ?>
                </select>
                ...
                <div ng-switch-when="<?php echo($driver_id); ?>">
                    <h5>Sürücü adı:&nbsp; <b><?php echo($driver_name); ?></b></h5>
                    <p>Cinsiyet:&nbsp; <b><?php echo($driver_gender); ?></b> </p>
                    <p>İletişim:&nbsp; <b><?php echo($driver_phone); ?></b> </p>
                </div>
                <?php }} ?>
                </div>
           ...
           <input type="submit"name="submit" value="kirala" class="btn btn-warning pull-right">     
        </form>
        
      </div>
      <div class="col-md-12" style="float: none; margin: 0 auto; text-align: center;">
            <h6><strong>Not:</strong> Vade tarihi sona erdikten sonraki her gün için <span class="text-danger">200 tl</span> ödeyeceksiniz.</h6>
        </div>
    </div>
